...
from agent_toolkit_cli.security.types import Verdict


def test_license_mit_is_green(tmp_path):
    from agent_toolkit_cli.security.license import scan_license
...
def test_code_scan_clean_is_green(tmp_path):
    from agent_toolkit_cli.security.code_scan import scan_code
...
def test_cache_round_trip(tmp_path):
    from agent_toolkit_cli.security.cache import load_cache, save_cache
...
def test_identity_renders_from_canned_signals():
    from agent_toolkit_cli.security.identity import render_from_signals
    signals = {
...
def test_credibility_renders_from_canned_signals():
    from agent_toolkit_cli.security.credibility import render_from_signals
...
def test_community_renders_from_canned_signals():
    from agent_toolkit_cli.security.community import render_from_signals
