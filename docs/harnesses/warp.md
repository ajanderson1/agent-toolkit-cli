...
- **Source:** [docs.warp.dev/agent-platform/capabilities/rules/](https://docs.warp.dev/agent-platform/capabilities/rules/) ("Project Rules… stored in an `AGENTS.md` file… filename must be in all caps")
...
- **Source:** [docs.warp.dev/agent-platform/capabilities/skills/](https://docs.warp.dev/agent-platform/capabilities/skills/)
