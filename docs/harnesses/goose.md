...
- **Source:** block/goose `crates/goose/src/hints/load_hints.rs` — `get_context_filenames()` defaults to `[".goosehints", "AGENTS.md"]`; `load_hints_from_directory` reads both project-cwd and `Paths::in_config_dir(...)`
...
- **Source:** block/goose blog 2025-09-26-subagents-vs-subrecipes
