...
v3.0.0 PR2 — re-exports the asset-type-blind lock-IO primitives from
`skill_lock`. The agent asset type uses the same LockEntry/LockFile structs;
...
a asset-type-aligned import path: `from agent_toolkit_cli.agent_lock import …`
