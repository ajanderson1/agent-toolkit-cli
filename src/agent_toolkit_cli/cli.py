...
from agent_toolkit_cli.commands._yaml_edit import yaml_edit
from agent_toolkit_cli.commands.check import check
from agent_toolkit_cli.commands.diff import diff
from agent_toolkit_cli.commands.doctor import doctor
from agent_toolkit_cli.commands.fix import fix
from agent_toolkit_cli.commands.ingest import ingest
from agent_toolkit_cli.commands.inventory import inventory
...
@click.group(
    help=(
        "agent-toolkit-cli — metadata-aware commands for asset frontmatter and AGENTS.md.\n\n"
...
def main(ctx: click.Context, toolkit_repo: Path | None, project_root: Path | None) -> None:
    """agent-toolkit-cli metadata commands."""
