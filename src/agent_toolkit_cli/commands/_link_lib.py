...
from agent_toolkit_cli._requires import RequiresUnsatisfied, parse_requires_entries
    ...
    *,
    ...
    for kind in KINDS_FOR_PROJECTION:
        if kind == "mcp":
            ...
            from agent_toolkit_cli.commands._mcp_dispatch import (  # noqa: PLC0415
                _build_mcp_entries,
        ...
        if kind == "hook":
            ...
            from agent_toolkit_cli.commands._hook_dispatch import (  # noqa: PLC0415
                _build_hook_entries,
